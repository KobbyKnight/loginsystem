...
if(isset($_POST['Submit']))
{
    ...
    $photo1=$_POST['photo1'];
    $email=$_POST['email'];
	mysqli_query($con,"update list set fname='$fname' ,lname='$lname' , dob='$dob',marital='$marital',phone='$phone',address='$raddress',provider='$provider',photo='$photo',photo1='$photo1',email='$email' where id='".$_GET['uid']."'");
...
<html lang="en">
  ...
  <section id="container" >
      ...
      <?php $ret=mysqli_query($con,"select * from list where id='".$_GET['uid']."'");
                  ...
                  <div class="col-md-12">
                      ...
                      <p align="center" style="color:#F00;"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']=""; ?></p>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="provider" value="<?php echo $row['Provider'];?>" >
                              </div>
                          </div>
