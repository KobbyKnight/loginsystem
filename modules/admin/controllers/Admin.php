...
class Admin extends CI_Controller
{
    ...
    public function dashboard()
    {
        if ($this->controller->checkSession()) {
            ...
            $data['notification'] = $this->model->get_notification();
            $data['body']          = 'dashboard';
    ...
    public function users($id = null){
        if ($this->controller->checkSession()) {
            ...
            $data['normal_users'] = $this->model->getAllwhere('users',$where);
            $data['notification'] = $this->model->get_notification();
    ...
    public function user_activate(){
        if ($this->controller->checkSession()) {
            ...
            $this->model->update($table,$update,$where);
        } else {
            redirect('admin/index');
        }
    }
    ...
    public function vehicleRequest(){
        if ($this->controller->checkSession()) {
            ...
            $data['vehiclerequestlist'] = $this->model->getAllwhere('vehicle_request',$where);
            $data['notification'] = $this->model->get_notification();
            $data['body']     = 'vehicleRequestList';
            $this->controller->load_view($data);
        } 
        else {
            redirect('admin/index');
    ...
    public function viewVehicalRequest(){
        if ($this->controller->checkSession()) {
            echo "lkbnvkldnb"; 
            die();
            $where =  array(
    ...
    public function editVehicalRequest(){
        if ($this->controller->checkSession()) {
            ...
            if($id)
            {
              ...
              $data['viewvehiclerequest'] = $this->model->getAllwhere('vehicle_request',$where); 
            }   

            $data['notification'] = $this->model->get_notification();
            $data['body']     = 'editVehicalRequest';
            $this->controller->load_view($data);
        } 
        else {
            redirect('admin/index');
    ...
    public function updaterequest()
    {
        if ($this->controller->checkSession()) {
            ...
            if($id)
            {
                ...
                $this->model->updateFields('vehicle_request',$data,$where);
                redirect('admin/vehicleRequest');
            }
