                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php echo base_url('admin/change_password') ?>" class="registration_form1" enctype="multipart/form-data">
                                <div class="form-group"> <label class="col-md-3">Old Password * </label>
                                ...
                                <div class="form-group"> <label class="col-md-3">New Password * </label>
                                ...
                                <div class="form-group"> <label class="col-md-3">Confirm Password * </label>
