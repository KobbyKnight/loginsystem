                        ...
                        <div class="col-lg-12 col-md-12">
                            <form role="form" method="post" action="<?php echo $url; ?>" class="registration_form1" enctype="multipart/form-data">
                                ...
                                <div class="form-group"> <label class="col-md-2">Breif Description  </label>
                                    <div class="col-lg-6"> <input class="form-control" type="text" name="brief_description" id="brief_description" placeholder="Brief Description" autocomplete="off" required="required" value="<?php if(!empty($page[0]->brief_description)){ echo $page[0]->brief_description;}else{ echo set_value('brief_description');} ?>"> <span class="red">
