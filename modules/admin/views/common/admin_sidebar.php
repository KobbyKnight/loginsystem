...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <i class="fa fa-bell"></i><span class="badge badge-warning"><?php echo count($notification); ?></span><i class="fa fa-caret-down"></i>
                </a>
                ...
                <ul class="dropdown-menu dropdown-user">
                    <?php
                      ...
                      ?>
                        <li style="font-size: 16px"><a href="<?php echo base_url('admin/editVehicalRequest/?id='.$notify['id']); ?>"><i class="fa fa-car fa-fw"></i> <?php echo $notify['chassis_number']; ?></a>
                        </li>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav sidebar-menu" id="side-menu" style="margin-top:50px">
                    ...
                    <li>
                        <a href="<?php echo base_url('admin/users')?>"><i class="fa fa-users fa-fw" style="font-size: 21px"></i> Users List</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('admin/vehicleRequest')?>"><i class="fa fa-paper-plane" style="font-size: 21px"></i>&nbsp; Vehicle Request List</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('admin/pendinglist')?>"><i class="fa fa-bell" style="font-size: 21px"></i> Payment Pending List</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('admin/paidregistration')?>"><i class="fa fa-medkit" style="font-size: 21px"></i>&nbsp; Paid List</a>
                    </li>
